...
lcd_init_4d:
; Power-up delay
    ldi     temp_r16, 100                       ; initial 40 mSec delay
    call    delayTx1mS
...
; Reset the LCD controller.
    ldi     temp_r16, lcd_FunctionReset         ; first part of reset sequence
    call    lcd_write_4
    ldi     temp_r16, 10                        ; 4.1 mS delay (min)
    call    delayTx1mS

    ldi     temp_r16, lcd_FunctionReset         ; second part of reset sequence
    call    lcd_write_4
    ldi     temp_r16, 200                       ; 100 uS delay (min)
    call    delayTx1uS

    ldi     temp_r16, lcd_FunctionReset         ; third part of reset sequence
    call    lcd_write_4
    ldi     temp_r16, 200                       ; this delay is omitted in the data sheet
    call    delayTx1uS
...
;   of the upper four bits of the instruction.
    ldi     temp_r16, lcd_FunctionSet4bit       ; set 4-bit mode
    call    lcd_write_4
    ldi     temp_r16, 80                        ; 40 uS delay (min)
    call    delayTx1uS

; Function Set instruction
    ldi     temp_r16, lcd_FunctionSet4bit       ; set mode, lines, and font
...
; Display On/Off Control instruction
    ldi     temp_r16, lcd_DisplayOff            ; turn display OFF
    call    lcd_write_instruction_4d
    ldi     temp_r16, 80                        ; 40 uS delay (min)
    call    delayTx1uS

; Clear Display instruction
    ldi     temp_r16, lcd_Clear                 ; clear display RAM
    call    lcd_write_instruction_4d
    ldi     temp_r16, 4                         ; 1.64 mS delay (min)
    call    delayTx1mS

; Entry Mode Set instruction
    ldi     temp_r16, lcd_EntryMode             ; set desired shift characteristics
    call    lcd_write_instruction_4d
    ldi     temp_r16, 80                        ; 40 uS delay (min)
    call    delayTx1uS
...
; Display On/Off Control instruction
    ldi     temp_r16, lcd_DisplayOn             ; turn the display ON
    call    lcd_write_instruction_4d
    ldi     temp_r16, 80                        ; 40 uS delay (min)
    call    delayTx1uS
    ret
...
lcd_write_string_4d_01:
    lpm     temp_r16, Z+                        ; get a character
...
lcd_write_character_4d:
    ...
    swap    temp_r16                        ; swap high and low nibbles
...
; set up D7
    ...
    sbrs    temp_r16, 7                         ; check the actual data value
...
delayTx1mS:
    call    delay1mS        ; delay for 1 mS
    dec     temp_r16        ; update the delay counter
...
delayTx1uS:
    ...
    dec     temp_r16                        ; decrement the delay counter
